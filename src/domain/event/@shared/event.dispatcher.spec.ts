...
import EnviaConsoleLog1Handler from "../customer/handler/enviar-console-log-1.handler";
import EnviaConsoleLog2Handler from "../customer/handler/enviar-console-log-2.handler";
import EnviaConsoleLogHandler from "../customer/handler/enviar-console-log.handler";
